package org.iffat.concurrency_extras;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Callable<Student> studentMarker = () -> {
			...
			Student student = new Student("Tim " + studentId, random.nextInt(2018, 2025),
					studentId);
		...
		for (int i = 0; i < 10; i++) {
			studentSet.clear();
			try {
				var futures = executor.invokeAll(Collections.nCopies(10, studentMarker));
